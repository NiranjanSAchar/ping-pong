...
- [done] Game behaves as expected
- [done] No bugs or crashes
- [done] Code reviewed with LLM
- [done] Final score and winner display works correctly
- [done] Score appears correctly on both player and AI sides
- [done] Dependencies listed in `requirements.txt`
- [done] README is followed during setup and testing
- [done] Codebase is clean, modular, and understandable
- [done] Submission should include the Chat/LLM used Page link with the complete chat history.